...
// Class definition.
public class NorthPoint extends CompassPoint
{
  // -------------------------- Class Variables ------------------------------/
  ...
  private int compassPoint = CompassDirections.NORTH;
