...
// Class definition.
public class EastPoint extends CompassPoint
{
  // -------------------------- Class Variables ------------------------------/

  // Define and initialize private panel constants.
  private final static int BEGIN_X =  0;
  private final static int BEGIN_Y =  0;
  private final static int END_X   = 10;
  private final static int END_Y   = 20;

  // Define and initialize compass direction.
  private int compassPoint = CompassDirections.EAST;

  // Define and initialize compass direction activator.
