...
// Class definition.
public class SouthPoint extends CompassPoint
{
  // -------------------------- Class Variables ------------------------------/
  ...
  protected final static int END_X   = 50;
  protected final static int END_Y   = 25;

  // Define and initialize compass direction.
  private int compassPoint = CompassDirections.SOUTH;
  ...
  ||  ---------  ----------------  -------------------------------------------
  ||  protected  Default           SouthPoint()
  */

  // Define default constructor.
  protected SouthPoint()
  {
    // Build the Panel.
    buildPanel();
